...
INSERT INTO Users (userID, name, email, password, roleID, duration) VALUES
  ('123e4567-e89b-12d3-a456-426614174000', 'John Doe', 'johndoe@example.com', 'password123', 2, 486),
  ('123e4567-e89b-12d3-a456-426614174001', 'Jane Smith', 'janesmith@example.com', 'password456', 3, 486),
  ('123e4567-e89b-12d3-a456-426614174002', 'Alice Johnson', 'alicejohnson@example.com', 'password789', 1, 486);
